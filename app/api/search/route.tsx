...
export const GET = async (request: NextRequest) => {
  ...
  const fooDBResults = query ? search(fooDBData.data, ['name','food_group','food_subgroup'], query) : fooDBData.data
  ...
  const results = {
    "shared": mergeFooDBAndFlavorBible(fooDBResults, flavorBibleResults["results (unique and combined list of ingredients and pairings)"]),
    "fooDBResults": fooDBResults,
    "flavorBibleResults": flavorBibleResults["results (unique and combined list of ingredients and pairings)"],
  }
